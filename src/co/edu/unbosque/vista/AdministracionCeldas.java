...
public class AdministracionCeldas extends DefaultTableCellRenderer {
	...
	/**
	 * <b>Precondiciones:</b> tener el parametro String y la variable tipo ya creada
	 * <b>Poscondiciones:</b> inicializa el parametro con la variable
	 * @param tipo String
	 */
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused,
		...
		if (selected) {
			...
			// Para las que no están seleccionadas se pinta el fondo de las celdas de
			// blanco
		...
		if (tipo.equals("texto")) {
			// si es tipo texto define el color de fondo del texto y de la celda así como
			// la alineación
			if (focused) {
